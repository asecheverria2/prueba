...
<div class="container">
    <div class="card">
        ...
        <ul>
            ...
            @endforeach
        </ul @endif <form action="{{route('tratamientos.store')}}" method="POST" novalidate>
        @csrf
            ...
            <label for="descripcion">Descripcion</label>
                        <input class="form-control String"  type="text"  name="descripcion" id="descripcion" value="{{old('descripcion')}}"             maxlength="100"
                                    required="required"
                        >
